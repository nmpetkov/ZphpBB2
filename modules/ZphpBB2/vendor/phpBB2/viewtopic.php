...
$ssu = ( isset($_GET['ssu']) ) ? intval($_GET['ssu']) : intval($_POST['ssu']);
$support_status = ($_GET['support_status']) ? intval($_GET['support_status']) : intval($_POST['support_status']);
...
// ZphpBB2 =>
	...
	'U_PRINT' => append_sid("printview.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;start=$start&amp;theme=printer"), 
// <= ZphpBB2
...
//	$poster = ( $poster_id == ANONYMOUS ) ? $lang['Guest'] : $postrow[$i]['username'];
	...
	$poster_profile = ( $poster_id == ANONYMOUS || !$userdata['session_logged_in'] ) ? DataUtil::formatForDisplay($poster) : '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . '=' . $poster_id) . '">' . DataUtil::formatForDisplay($poster) . '</a>';  
// End PNphpBB2 Module
...
/* End PNphpBB2 Module */
		...
		'POSTER_FIRSTLASTNAMES' => $poster_firstlastnames,
