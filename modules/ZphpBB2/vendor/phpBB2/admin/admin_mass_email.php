...
*
*     $Id: admin_mass_email.php 192 2007-01-20 15:17:44Z kronos $
*
****************************************************************************/
...
//	$module['General']['Mass_Email'] = $filename;
	$phpbb_module['General']['Mass_Email'] = $filename;
// End PNphpBB2 Module
...
//		message_die(GENERAL_MESSAGE, $lang['Email_sent'] . '<br /><br />' . sprintf($lang['Click_return_admin_index'],  '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>'));
		message_die(GENERAL_MESSAGE, $lang['Email_sent'] . '<br /><br />' . sprintf($lang['Click_return_admin_index'],  '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>'));
// End PNphpBB2 Module
	}
}	
