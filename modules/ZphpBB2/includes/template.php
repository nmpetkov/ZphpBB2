 ...
 *
 *   $Id: template.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
*/
		...
		{
			$tmpfile = phpbb_realpath('./modules/' . $ModName . $filename);
		}
		if (!file_exists($tmpfile))
		{
		 	// Check alternate template location PNTheme
			$tmpfile = phpbb_realpath('./modules/' . $ModName . '/templates/PNTheme/' . $filename);
			if (!file_exists($tmpfile))
			{
			 	 die("Template->make_filename(): Error - file $filename does not exist");
			}
