...
// Begin PNphpBB2 Module
		$use_gravatar = ( isset($_POST['usegravatar']) ) ? ( ( $_POST['usegravatar']) ? TRUE : 0 ) : $board_config['allow_gravatars'];
// End PNphpBB2 Module
...
// Begin PNphpBB2 Module
		$use_gravatar = ( isset($_POST['usegravatar']) ) ? ( ($_POST['usegravatar']) ? TRUE : 0 ) : ( ( $userdata['user_avatar_type'] == 5) ? TRUE : 0);
// End PNphpBB2 Module
...
//	if ( isset($_POST['avatardel']) && $mode == 'editprofile' )
	if ( ( isset($_POST['avatardel']) || ( $userdata['user_avatar_type'] == 5 && !$use_gravatar ) ) && $mode == 'editprofile' )
// End PNphpBB2 Module
	{
