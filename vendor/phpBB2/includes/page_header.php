...
// ZphpBB2
$admin_link = ( $userdata['user_level'] == ADMIN ) ? '<a href="' . ModUtil::url('ZphpBB2', 'admin', 'main') . '">' . $lang['Admin_panel'] . '</a>' : '';

if ($board_config['pnphpbb2_allow_full_page'] == 1 || $board_config['pnphpbb2_full_page'] == 1)
{
 	 if (SessionUtil::getVar('fullpage') == 1)
	 {
...
//					$style_color = 'style="color:#' . $theme['fontcolor3'] . '"';
					$row['username'] = '<b>' . DataUtil::formatForDisplay($row['username']) . '</b>';
...
/*
 if (SecurityUtil::checkPermission('ZphpBB2::', '::', ACCESS_ADMIN) && DEBUG)
 {
...
/*	'L_WHOSONLINE_MOD' => sprintf($lang['Mod_online_color'], '<span style="color:#' . $theme['fontcolor2'] . '">', '</span>'), */
	...
	'L_MIN_MAX' => ($fullpage == 1) ? $lang['ZphpBB2_Minimize'] : $lang['ZphpBB2_Maximize'],
	'L_SUBFORUM_IMAGE' => ($subforum == 1) ? "icon_subforum_off.gif" : "icon_subforum_on.gif",
	'L_SUBFORUM' => ($subforum == 1) ? $lang['ZphpBB2_SubForum_Off'] : $lang['ZphpBB2_SubForum_On'],
...
/*	'U_REGISTER' => append_sid('profile.'.$phpEx.'?mode=register'), */
	'U_REGISTER' => ModUtil::url('Users', 'user', 'register'),
	...
	'U_ADMIN_LINK' => ModUtil::url('ZphpBB2', 'admin', 'main'),
/* End PNphpBB2 Module */
	'U_PROFILE' => append_sid('profile.'.$phpEx.'?mode=editprofile'),
/* Begin PNphpBB2 Module */
/*	'U_PRIVATEMSGS' => append_sid('privmsg.'.$phpEx.'?folder=inbox'), */
	'U_PRIVATEMSGS' => (($board_config['pnphpbb2_pn_pm']) ? ModUtil::url('InterCom', 'user', 'main') : append_sid('privmsg.'.$phpEx.'?folder=inbox')),
...
*/
	...
	'USERS_MODULE_AUTHID' => SecurityUtil::generateAuthKey('Users'),
...
$sub_forum = ($board_config['pnphpbb2_allow_sub_change'] == 1) ? SessionUtil::getVar('subforum') : $board_config['pnphpbb2_sub_forum'];
