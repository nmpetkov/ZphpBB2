...
/* ZphpBB2 => */
							'U_TOPIC' => $board_config['server_name'] . ModUtil::url('ZphpBB2', 'user', 'viewtopic', array(POST_POST_URL => $post_id.'#'.$post_id)),
							'U_STOP_WATCHING_TOPIC' => $board_config['server_name'] . ModUtil::url('ZphpBB2', 'user', 'viewtopic', array(POST_TOPIC_URL => $$topic_id, 'unwatch' => 'topic')))
/* <= ZphpBB2 */
						);
