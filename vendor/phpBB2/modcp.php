...
if ( isset($_POST['cancel']) && !isset($_POST['select_from']) && !isset($_POST['select_to']) )
...
/* Begin PNphpBB2 Module */
/*						'POSTER_NAME' => $poster, */
						'POSTER_NAME' => DataUtil::formatForDisplay($poster),
/* End PNphpBB2 Module */
						'POST_DATE' => $post_date,
...
// Begin PNphpBB2 Module
	case 'merge':
		...
		{
		  $topic_title = htmlspecialchars(trim(stripslashes($_POST['topic_title'])));
		}
...
/*					'L_SEARCH_POSTS' => sprintf($lang['Search_user_posts'], $username),  */
					'L_SEARCH_POSTS' => sprintf($lang['Search_user_posts'], DataUtil::formatForDisplay($username)), 
/* End PNphpBB2 Module */
