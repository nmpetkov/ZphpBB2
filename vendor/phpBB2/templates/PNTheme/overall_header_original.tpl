  ...
  <tr>
    <td align="center" valign="top">
      ...
      <table class="topbkg" width="100%" cellspacing="2" cellpadding="1" border="0">
        <tr>
          <td align="left" valign="top" width="25%"><a href="{U_INDEX}"><img src="templates/{T_THEME_NAME}/images/{THEME_IMAGES}logo_phpBB_med.gif" border="0" alt="{L_INDEX}" title="{L_INDEX}" {LOGOSIZE} /></a></td>
        </tr>
      </table>
      <!-- END switch_logo_on -->
