...
* @version $Id: admin_attachments.php 192 2007-01-20 15:17:44Z kronos $
...
*/
	$phpbb_module['Attachments']['Manage'] = $filename . '?mode=manage';
	$phpbb_module['Attachments']['Shadow_attachments'] = $filename . '?mode=shadow';
	$phpbb_module['Extensions']['Special_categories'] = $filename . '?mode=cats';
	$phpbb_module['Attachments']['Sync_attachments'] = $filename . '?mode=sync';
	$phpbb_module['Attachments']['Quota_limits'] = $filename . '?mode=quota';
// End PNphpBB2 Module

// Begin PNphpBB2 Module
	$phpbb_module['Attachments']['Users_aguide'] = "<>" . System::getBaseUrl() . "modules/ZphpBB2/vendor/phpBB2/docs/attach_user_guide.html";
// End PNphpBB2 Module
	return;
}
...
//		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=manage") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>'));
		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=manage") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>'));
// End PNphpBB2 Module
	}
}
...
//	$message = $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=shadow") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>');
	$message = $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=shadow") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>');
// End PNphpBB2 Module
...
//		message_die(GENERAL_MESSAGE, $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=cats") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>'));
		message_die(GENERAL_MESSAGE, $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=cats") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>'));
// End PNphpBB2 Module
	}
}
...
//		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=cats") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>'));
		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=cats") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>'));
// End PNphpBB2 Module
	}
}
...
//				die('Could not update thumbnail informations -> ' . $error['message'] . ' -> ' . $sql);
				message_die(GENERAL_ERROR, 'Could not update thumbnail informations<br />' . $error['message'], '', __LINE__, __FILE__, $sql);
// End PNphpBB2 Module
			}
		}
		$i++;
...
//	die('<br /><br /><br />' . $lang['Attach_sync_finished'] . '<br /><br />' . $info);
	message_die(GENERAL_MESSAGE, $lang['Attach_sync_finished'] . '<br /><br />' . $info);
// End PNphpBB2 Module
	exit;
}
...
//		$message = $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=quota") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>');
		$message = $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="' . append_sid("admin_attachments.$phpEx?mode=quota") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>');
// End PNphpBB2 Module
...
/*				'USERNAME'		=> $rows[$i]['username']) */
				'USERNAME'		=> DataUtil::formatForDisplay($rows[$i]['username']))
/* End PNphpBB2 Module */
			);
		}
