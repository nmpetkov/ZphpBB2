 ...
 *
 *   $Id: admin_board.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
//	$module['General']['Configuration'] = $file;
	$phpbb_module['General']['Configuration'] = $file;
	$phpbb_module['General']['Forum_Manual'] = "<>" . System::getBaseUrl() . "modules/ZphpBB2/docs/PNphpBB2_Users_Guide.html";
// End PNphpBB2 Module
	return;
}
...
//				WHERE config_name = '$config_name'";
			$sql = "UPDATE " . CONFIG_TABLE . " SET
				config_value = '" . DataUtil::formatForStore(htmlspecialchars($new[$config_name])) . "'
				WHERE config_name = '$config_name'";
// End PNphpBB2 Module
			if( !$db->sql_query($sql) )
			{
	...
	{
// Begin PNphpBB2 Module
		$message = $lang['Config_updated'] . "<br /><br />" . sprintf($lang['Click_return_config'], "<a href=\"" . append_sid("admin_board.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("admin.$phpEx?pane=right") . "\">", "</a>");
// End PNphpBB2 Module
...
$style_select = style_select($new['default_style'], 'default_style', $phpbb_root_path . "templates");
...
/*	"SITE_DESCRIPTION" => $new['site_desc'], */ 
	"SERVER_NAME" => "POSTNUKE", 
	"SCRIPT_PATH" => "POSTNUKE", 
	"SERVER_PORT" => "N/A", 
	"SITENAME" => "POSTNUKE",
	"SITE_DESCRIPTION" => "POSTNUKE", 
/* End PNphpBB2 Module */
