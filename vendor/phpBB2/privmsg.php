...
/*		'MESSAGE_FROM' => $username_from, */
		'MESSAGE_TO' => DataUtil::formatForDisplay($username_to),
		'MESSAGE_FROM' => DataUtil::formatForDisplay($username_from),
/* End PNphpBB2 Module */
...
//					AND user_id <> " . ANONYMOUS;
			$sql = "SELECT user_id, user_notify_pm, user_email, user_lang, user_active 
				FROM " . USERS_TABLE . "
				WHERE username = '" . DataUtil::formatForStore($to_username) . "'
					AND user_id <> " . ANONYMOUS;
// End PNphpBB2 Module
			if ( !($result = $db->sql_query($sql)) )
			{
...
/*	 			 	'USERNAME' => stripslashes($to_username), */
					'USERNAME' => DataUtil::formatForDisplay($to_username), 
/* End PNphpBB2 Module */
					'SITENAME' => $board_config['sitename'],
					'EMAIL_SIG' => (!empty($board_config['board_email_sig'])) ? str_replace('<br />', "\n", "-- \n" . $board_config['board_email_sig']) : '', 

/* ZphpBB2 => */
					'U_INBOX' => $board_config['server_name'] . ModUtil::url('ZphpBB2', 'user', 'privmsg', array('folder' => 'inbox')))
/* <= ZphpBB2 */
				);
...
/*			'MESSAGE_FROM' => $userdata['username'],  */
			'MESSAGE_TO' => DataUtil::formatForDisplay($to_username), 
			'MESSAGE_FROM' => DataUtil::formatForDisplay($userdata['username']), 
/* End PNphpBB2 Module */
...
/*		'USERNAME' => $to_username, */
		'USERNAME' => DataUtil::formatForDisplay(preg_replace($html_entities_match, $html_entities_replace, $to_username)),
/* End PNphpBB2 Module */
...
//		$msg_username = $row['username'];
		$msg_username = DataUtil::formatForDisplay($row['username']);
// End PNphpBB2 Module
...
//			$msg_username = '<b>' . $msg_username . '</b>';
			$msg_username = '<b>' . DataUtil::formatForDisplay($msg_username) . '</b>';
// End PNphpBB2 Module
		}
