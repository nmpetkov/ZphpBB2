 ...
 *
 *   $Id: bbcode.php 192 2007-01-20 15:17:44Z kronos $
 *
 ***************************************************************************/
...
// Begin PNphpBB2 Module (Optional code block by Daz)
	$bbcode_tpl['code_open'] = str_replace('{IMAGE_PATH}', $board_config['path_images'], $bbcode_tpl['code_open']);
	$bbcode_tpl['code_open'] = str_replace('{L_CODE_MORE}', $lang['code_more'], $bbcode_tpl['code_open']);
	$bbcode_tpl['code_open'] = str_replace('{L_CODE_EVEN_MORE}', $lang['code_even_more'], $bbcode_tpl['code_open']);
	$bbcode_tpl['code_open'] = str_replace('{L_CODE_LESS}', $lang['code_less'], $bbcode_tpl['code_open']);
	$bbcode_tpl['code_open'] = str_replace('{L_CODE_SELECT}', $lang['code_select'], $bbcode_tpl['code_open']);
// End PNphpBB2 Module
...
// Begin PNphpBB2 Module
	...
	else
	{
		...
		$match[] = '#' . pnGetBaseURL() . preg_replace('/^\/?(.*?)(\/)?$/', '\1', trim($config['script_path'])) . '/([^ \t\n\r <"\']+)#i';
...
//			$repl[] = '<img src="'. $board_config['smilies_path'] . '/' . $smilies[$i]['smile_url'] . '" alt="' . $smilies[$i]['emoticon'] . '" border="0" />'; 
			$repl[] = '<img src="modules/' . $ModName . '/' . $board_config['smilies_path'] . '/' . $smilies[$i]['smile_url'] . '" alt="' . $smilies[$i]['emoticon'] . '" border="0" />';
// End PNphpBB2 Module
		}
	}
