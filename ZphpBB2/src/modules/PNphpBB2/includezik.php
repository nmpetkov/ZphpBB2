...
global $minmax;
$minmax = FormUtil::getPassedValue('minmax', 0, 'GETPOST'); # PNphpBB2
if ($minmax==1) {
	PageUtil::registerVar('sitemaxstate', false, 1); #PNphpBB2: to be available in theme, to mimic maximized forum
}
