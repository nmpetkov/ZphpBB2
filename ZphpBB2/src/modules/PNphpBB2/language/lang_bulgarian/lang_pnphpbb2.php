...
$lang['PNphpBB2_Change_Profile'] = iconv('CP1251',_CHARSET, 'Промени профила си в сайта'); # Change Your PostNuke Profile
$lang['PNphpBB2_Refresh_Profile'] = iconv('CP1251',_CHARSET, 'Опресни профила си в сайта'); # Refresh Your PostNuke Profile
$lang['PNphpBB2_Profile_Info'] = iconv('CP1251',_CHARSET, 'Тази информация се използва само във форума. Общите данни за форума  и другите секции на сайта се настройват от "Моят профил" в менюто на сайта.'); # This information is used in PNphpBB2 only. All profile information that is shared between PostNuke and PNphpBB2 is set in the PostNuke Profile Settings.
$lang['PNphpBB2_Get_PN_Avatar'] = iconv('CP1251',_CHARSET, 'От сайта'); # From PostNuke
...
$lang['PNphpBB2_Minimize'] = iconv('CP1251',_CHARSET, "Минимизирай"); # Minimize
$lang['PNphpBB2_Maximize'] = iconv('CP1251',_CHARSET, "Максимизирай");  # Maximize

// Full page maximize/minimize
$lang['PNphpBB2_SubForum_Off'] = iconv('CP1251',_CHARSET, "Подкатегория"); # Sub-Category
$lang['PNphpBB2_SubForum_On'] = iconv('CP1251',_CHARSET, "Подфорум"); # Sub-Forum
