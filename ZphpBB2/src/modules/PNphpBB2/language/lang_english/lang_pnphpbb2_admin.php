...
if ( defined('PNPHPBB_INSTALL') )
{
  ...
  $lang['PNphpBB2_Delete_Users'] = "Deleting users from Zikula (Except Admin!)";
  $lang['PNphpBB2_Delete_Groups'] = "Delete user id's from the group membership table";
  $lang['PNphpBB2_Populate_Users'] = "Populating Zikula user and group tables with phpBB users";
  ...
  $lang['PNphpBB2_phpBB_Tables_Found'] = "phpBB_* tables have been found in your Zikula database. It is VERY important";
  ...
  $lang['PNphpBB2_Upgrade_Disclaimer'] .= "<b>Selecting option 3 (three)</b> Will perform a NEW install of PNphpBB2 and leave the existing phpBB_* tables that are found in your Zikula database.</br></br>";
  $lang['PNphpBB2_Upgrade_Disclaimer'] .= "Once this is done there is NO WAY to turn back from this upgrade, so be very sure you have a recent backup of your Zikula and phpBB2 databases.";
  ...
  $lang['PNphpBB2_Remove_Text'] = "Your about to remove PNphpBB2 and all its associated tables from Zikula (%s*).<br /><br />All data will be lost, are you sure you wish to do this?";
...
$lang['Rank_image_explain'] .= '<br/>This is relative to PNphpBB2 root path if you include a path relative to the where the images are located.<br/>(NOTE: If only the image is specified (image.gif), then an attempt will be made to use the image based on the template name, Zikula theme, and language.)'; 
