 ...
 *
 *   $Id: admin_ug_auth.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
//	$module['Groups']['Permissions'] = $filename . "?mode=group";
	$phpbb_module['Users']['Permissions'] = $filename . "?mode=user";
	$phpbb_module['Groups']['Permissions'] = $filename . "?mode=group";
// End PNphpBB2 Module
...
//		$message = $lang['Auth_updated'] . '<br /><br />' . sprintf($lang['Click_return_userauth'], '<a href="' . append_sid("admin_ug_auth.$phpEx?mode=$mode") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>');
		$message = $lang['Auth_updated'] . '<br /><br />' . sprintf($lang['Click_return_userauth'], '<a href="' . append_sid("admin_ug_auth.$phpEx?mode=$mode") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>');
// End PNphpBB2 Module
...
//			$message = $lang['Auth_updated'] . '<br /><br />' . sprintf($l_auth_return, '<a href="' . append_sid("admin_ug_auth.$phpEx?mode=$mode") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>');
			$message = $lang['Auth_updated'] . '<br /><br />' . sprintf($l_auth_return, '<a href="' . append_sid("admin_ug_auth.$phpEx?mode=$mode") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>');
// End PNphpBB2 Module
		}
...
/* Begin PNphpBB2 Module */
/*			'USERNAME' => $t_username, */
			'USERNAME' => pnVarPrepForDisplay($t_username),
/* End PNphpBB2 Module */
...
/*			'USERNAME' => $t_groupname, */
			'USERNAME' => pnVarPrepForDisplay($t_groupname),
/* End PNphpBB2 Module */
