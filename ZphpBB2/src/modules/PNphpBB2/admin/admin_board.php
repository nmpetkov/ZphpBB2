...
//	$module['General']['Configuration'] = $file;
	...
	$phpbb_module['General']['Forum_Manual'] = "<>" . pnGetBaseURL() . "modules/PNphpBB2/docs/PNphpBB2_Users_Guide.html";
// End PNphpBB2 Module
	return;
}
...
//				WHERE config_name = '$config_name'";
			$sql = "UPDATE " . CONFIG_TABLE . " SET
				config_value = '" . pnVarPrepForStore(htmlspecialchars($new[$config_name])) . "'
				WHERE config_name = '$config_name'";
// End PNphpBB2 Module
			if( !$db->sql_query($sql) )
			{
