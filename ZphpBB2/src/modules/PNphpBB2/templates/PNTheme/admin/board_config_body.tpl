...
<tr> 
<th colspan="2" class="thc">{L_GENERAL_SETTINGS}</th>
</tr>
<tr> 
...
<span class="gensmall">{L_SEARCH_FLOOD_INTERVAL_EXPLAIN}</span></td> 
<td class="row2">
<input type="text" size="3" maxlength="4" name="search_flood_interval" value="{SEARCH_FLOOD_INTERVAL}" class="post" /></td>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_COOKIE_SETTINGS}</th>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_PRIVATE_MESSAGING}</th>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_ABILITIES_SETTINGS}</th>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_AVATAR_SETTINGS}</th>
</tr>
<tr> 
<td class="row1">{L_ALLOW_GRAVATARS}</td>
<td class="row2"> 
<input type="radio" name="allow_gravatars" value="1" {ALLOW_GRAVATARS_YES} />
{L_YES}&nbsp;&nbsp; 
<input type="radio" name="allow_gravatars" value="0" {ALLOW_GRAVATARS_NO} />
{L_NO}</td>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_COPPA_SETTINGS}</th>
</tr>
<tr> 
...
<tr> 
<th colspan="2" class="thc">{L_EMAIL_SETTINGS}</th>
</tr>
<tr> 
