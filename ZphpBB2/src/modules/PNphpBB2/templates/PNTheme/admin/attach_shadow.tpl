<table width="100%" border="0" cellpadding="3" cellspacing="1" border="0" class="forumline">
<tr><td class="row2" align="center">
<h1>{L_SHADOW_TITLE}</h1></td>
<td class="row2">
<p>{L_SHADOW_EXPLAIN}</p></td>
</tr></table>
{ERROR_BOX}
...
<form method="post" name="shadow_list" action="{S_ATTACH_ACTION}">
  ...
  <table width="100%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <td class="cat" colspan="5" align="center" height="28"><span class="cattitle">{L_SHADOW_TITLE}</span> 
	  </td>
	</tr>
	<tr> 
...
{S_HIDDEN}
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr> 
	  <td class="row2" align="right" valign="top" nowrap="nowrap"><b><span class="gensmall"><a href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></b></td>
	</tr>
  </table>
