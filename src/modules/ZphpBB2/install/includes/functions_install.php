...
function page_header($text, $form_action = false, $form_name = "install")
{
  ...
  if (!pnModAvailable('Encompass'))
  {
	...
	echo "              <tr>\n";
	echo "                <td>\n";
	echo "                  <img src= \"" . $phpbb_root_path . "images/logo.gif\" border=\"0\" alt=\"ZphpBB2\" vspace=\"1\">\n";
	echo "                </td>\n";
