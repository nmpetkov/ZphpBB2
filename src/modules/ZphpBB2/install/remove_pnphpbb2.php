 ...
 *
 ***************************************************************************/
// ZphpBB2 databse table removal utility.
...
//
// NOTE: The ZphpBB2 directory MUST exist to run this script
// 
...
if (empty($ModName))
{
	 $ModName = ($HTTP_GET_VARS['name']) ? $HTTP_GET_VARS['name'] : "ZphpBB2";
}
...
page_header($lang['ZphpBB2_Remove_Prompt'], "index.php?module=Modules&type=admin&func=list");
...
evaluate_statement($sql_query, sprintf($lang['ZphpBB2_Remove_Title'], $table_prefix));

if ($errored)
{
	page_common_text($lang['ZphpBB2_Some_Failed'], "center");
	...
	page_common_text($lang['ZphpBB2_Some_Failed'], "left");
}
else
{
  $removed = true;
...
page_common_text("-", "center");
page_common_text($lang['ZphpBB2_Remove_Notes'], "left");
