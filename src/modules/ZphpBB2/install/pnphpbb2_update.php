...
page_header($lang['ZphpBB2_Upgrade'], 'index.php?module=Modules&type=admin&func=list');
...
if (defined("OLD_PHPBB_INSTALLED"))
{
	...
	if (!$continue_move)
	{
		...
		// ZphpBB2 or phpBB2pnmod-F, -203, -203-Attachments and there are
		// already tables in the new location. We can not continue.
		page_common_text(sprintf($lang['ZphpBB2_Move_Tables_No'], $table_prefix, $modversion['old_table_prefix']), "center", true, true);
		page_common_text($lang['ZphpBB2_Upgrade'] . " " . $lang['ZphpBB2_Aborted'], "center", true, true);
		page_common_text("-", "center");
	...
	else
	{
		...
		$result = evaluate_statement($sql_query, $lang['ZphpBB2_Move_Tables_Yes']);
...
if (defined("PHPBB2_TO_PNPHPBB2") && !($errored) )
{
	...
	$result = evaluate_statement($sql_query, $lang['ZphpBB2_Delete_Users']);
	...
	$result = evaluate_statement($sql_query, $lang['ZphpBB2_Delete_Groups']);
	 
	echo "              <tr>\n";
	echo "                <td>" . $lang['ZphpBB2_Populate_Users'] . "</td>\n";
	...
	if ( $errored )
	{
		echo "                <td><blink><font color=\"#FF0000\"><b>" . $lang['ZphpBB2_Failed'] . "</b></font></blink></td>\n";
	}
	else
	{
		echo "                <td><b><font color=\"#008000\">" . $lang['ZphpBB2_Completed'] . "</font></b></td>\n";
	}
	echo "              </tr>\n"; 
}
...
// Trick ZphpBB2 1.2h-RC3(b) into thinking that its at phpBB version 2.0.14
...
{
  echo "              <tr>\n";
  echo "                <td>" . sprintf($lang['ZphpBB2_Update_phpBB'], $prev_version, "<b>2" . $modversion['phpbb_version']) . "</b></td>\n";
  if ( $errored )
  {
    echo "                <td><blink><font color=\"#FF0000\"><b>" . $lang['ZphpBB2_Failed'] . "</b></font></blink></td>\n";
  }
...
{
  echo "              <tr>\n";
  echo "                <td>" . $lang['ZphpBB2_Update_Data'] . "</td>\n";
  if ( $errored )
  {
    echo "                <td><blink><font color=\"#FF0000\"><b>" . $lang['ZphpBB2_Failed'] . "</b></font></blink></td>\n";
  }
...
switch (SQL_LAYER)
{
	...
	case 'mysql4':
		...
		evaluate_statement($sql_query, $lang['ZphpBB2_Optimize_Analyze']);
		break;

	case 'postgresql':
		evaluate_statement("VACUUM ANALYZE;", $lang['ZphpBB2_Optimize_Analyze']);
		break;
}
...
if (defined("ATTACH_INSTALL"))
{
   ...
   $result = evaluate_statement($sql_query, $lang['ZphpBB2_Installing'] . ' ' . $lang['ZphpBB2_Attach'] . ATTACH_VERSION, false, true);
}
...
if (defined("ATTACH_UPDATE") && !defined("ATTACH_INSTALL"))
{
  //
	...
	// page_common_text('<h4>' . $lang['ZphpBB2_Updating'] . ' ' . $lang['ZphpBB2_Attach'] . ATTACH_VERSION . '</h4>', "center");
  ...
  switch ( $attach_version )
  {
    ...
    case '2.3.6';
		  ...
		  {
        page_common_text($lang['ZphpBB2_Cant_SQL'], "center");
		  }
    case '2.3.7';
    case '2.3.8';
...
// Begin ZphpBB2 Attachment Mod
	$cache_dir = $phpbb_root_path . '/attach_cache';
// End ZphpBB2 Attachment Mod
  ...
  if ( $attach_update == true )
  {
    ...
    echo "              <tr>\n";
    echo "                <td>" . sprintf($lang['ZphpBB2_Update_Attach'], "<b>" . $attach_version . "</b>", "<b>" . ATTACH_VERSION) . "</b></td>\n";
    if ( $errored )
    {
      echo "                <td><blink><font color=\"#FF0000\"><b>" . $lang['ZphpBB2_Failed'] . "</b></font></blink></td>\n";
    }
...
switch ($pnphpbb_version)
{
	...
	case '1.0':
	  ...
	  // Begin ZphpBB2 update for paths and default theme to PNTheme
		update_config("script_path", "modules/ZphpBB2/");
...
if ( $pnphpbb_version <> $modversion['version'] )
{
  ...
  if ( $pnphpbb_version == "" )
  {
    echo "                <td>" . sprintf($lang['ZphpBB2_Install_PNphpBB'], $modversion['version']) . "</td>\n";
  }
  else
  {
    echo "                <td>" . sprintf($lang['ZphpBB2_Update_phpBB'], $pnphpbb_version, $modversion['version']) . "</td>\n";
  }
  if ( $errored )
  {
    echo "                <td><blink><font color=\"#FF0000\"><b>" . $lang['ZphpBB2_Failed'] . "</b></font></blink></td>\n";
...
if ( $errored )
{
 	 page_common_text($lang['ZphpBB2_Some_Failed'], "left", true);
...
{
	 page_common_text($lang['ZphpBB2_No_Errors'], "left", true);
}
...
{
	// Success
	pnSessionSetVar('statusmsg', $lang['ZphpBB2_Installed']);
...
page_common_text($lang['ZphpBB2_Update_Complete'], "left");
