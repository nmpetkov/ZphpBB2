...
//			'RULES'							=> '<a href="' . append_sid($phpbb_root_path . "attach_rules.$phpEx?f=$u_rules_id") . '" target="_blank">' . $lang['Allowed_extensions_and_sizes'] . '</a>',
			'RULES' => '<a href="' . append_sid("posting.$phpEx?mode=rules?f=$u_rules_id") . '" onclick="window.open(\'' . append_sid("posting.$phpEx?mode=rules?f=$u_rules_id") . '\', \'_attachrules\', \'HEIGHT=250,resizable=yes,scrollbars=yes,WIDTH=300\');return false;" target="_attachrules">' . $lang['Allowed_extensions_and_sizes'] . '</a>',
/* End PNphpBB2 Module */
