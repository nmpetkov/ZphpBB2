...
if ( defined('PNPHPBB_INSTALL') )
{
  ...
  $lang['ZphpBB2_Installed'] = "ZphpBB2 Installed & Activated.";
  $lang['ZphpBB2_Install_Title'] = "Installing ZphpBB2 tables to %s*";
  $lang['ZphpBB2_Install_Complete']  = "<b>ZphpBB2 basic installation is now complete.</b><br /><br />";
  $lang['ZphpBB2_Install_Complete'] .= "Click on Finish Installation to return to the PN module administration page, and activate ZphpBB2.<br /><br />";
  $lang['ZphpBB2_Install_Complete'] .= "You can access the forum administration page through the PN administration page or with the link located in the forum.<br /><br />";
  $lang['ZphpBB2_Install_Complete'] .= "Please be sure to check the General Configuration details and make any required changes. <br /><br /><b>Thank you for choosing ZphpBB2.</b>";
  ...
  $lang['Write_Perm_2'] = "Module MUST be located in modules/ZphpBB2.";
  $lang['Write_Perm_3'] = "./modules/ZphpBB2/templates/PNTheme/styles IS writable.";
  $lang['Write_Perm_4'] = "./modules/ZphpBB2/templates/PNTheme/styles is NOT writable";
  $lang['Write_Perm_5'] = "./modules/ZphpBB2/templates/PNTheme/cellpics IS writable.";
  $lang['Write_Perm_6'] = "./modules/ZphpBB2/templates/PNTheme/cellpics is NOT writable.";
  ...
  $lang['Location_Correct'] = "ZphpBB2 must be located in the directory ZphpBB2 under modules.";
  ...
  $lang['ZphpBB2_Move_Tables_No'] = "Tables currently exist in %s*.<br /><br />The tables %s* can not be moved.";
  $lang['ZphpBB2_Move_Tables_Yes'] = "Moving tables to new location";
  $lang['ZphpBB2_Delete_Users'] = "Deleting users from Zikula (Except Admin!)";
  $lang['ZphpBB2_Delete_Groups'] = "Delete user id's from the group membership table";
  $lang['ZphpBB2_Populate_Users'] = "Populating Zikula user and group tables with phpBB users";
  $lang['ZphpBB2_Database_Type'] = "Database type";
  $lang['ZphpBB2_Update_phpBB'] = "Updating phpBB version %s to version %s";
  $lang['ZphpBB2_Update_PNphpBB'] = "Updating PNphpBB version %s to version %s";
  $lang['ZphpBB2_Update_Attach'] = "Updating Attachment Mod version %s to version %s";
  $lang['ZphpBB2_Install_PNphpBB'] = "Performing PNphpBB %s specific database changes";
  $lang['ZphpBB2_Optimize_Analyze'] = 'Optimizing tables';
  $lang['ZphpBB2_Update_Schemas'] = "Updating database schema";
  $lang['ZphpBB2_No_Updates'] =  "No updates required";
  $lang['ZphpBB2_Update_Data'] = "Updating data";
  $lang['ZphpBB2_Attach'] = "Attachment Mod Version ";
  $lang['ZphpBB2_Updating_Paths'] = "Updating config table";
  $lang['ZphpBB2_Delete_Themes'] = "Deleting old themes/style records";
  $lang['ZphpBB2_Install_Themes'] = "Installing new theme (PNTheme)";
  $lang['ZphpBB2_Board_Theme'] = "Setting board default theme to PNTheme";
  $lang['ZphpBB2_User_Theme'] = "Setting theme for all users to PNTheme";
  $lang['ZphpBB2_Clear_Sessions'] = "Clearing ALL sessions from sessions table";
  $lang['ZphpBB2_Cant_SQL'] = "CAN'T CHANGE MSSQL-TABLE. PLEASE DO THE FOLLOWING MANUALLY:<br />IN PHPBB_QUOTA_LIMITS, CHANGE QUOTA_LIMIT TO FROM INT TO BIGINT.</p>";
  $lang['ZphpBB2_Update_Complete'] = "ZphpBB2 update is now complete.";
  ...
  $lang['ZphpBB2_Update_Complete'] .= "<b>Thank you for choosing PNphpBB!</b>";
  $lang['ZphpBB2_phpBB_Tables_Found'] = "phpBB_* tables have been found in your Zikula database. It is VERY important";
  $lang['ZphpBB2_phpBB_Tables_Found'] .= " that you understand what this script is about to do.";
  $lang['ZphpBB2_three_options'] = "You have four (4) options at this point.";
  $lang['ZphpBB2_option_one'] = "1) Upgrade from a previous version of ZphpBB2 or phpBB2pnmod";
  $lang['ZphpBB2_option_two'] = "2) Convert a stand alone version of phpBB (Version 2.0.x) to ZphpBB2";
  $lang['ZphpBB2_option_three'] = "3) Perform a NEW install of ZphpBB2";
  $lang['ZphpBB2_option_four'] = "4) Abort installation";
  $lang['ZphpBB2_Upgrade_Disclaimer'] = "PLEASE! Understand the following <font color=\"red\"><b>WARNINGS:</b></font><br /><br />";
  $lang['ZphpBB2_Upgrade_Disclaimer'] .= "<b>Selecting option 2 (two)</b> will delete ALL users from your existing PN database then insert all user information from the phpBB2 tables.</br><br />";
  $lang['ZphpBB2_Upgrade_Disclaimer'] .= "<b>Selecting option 3 (three)</b> Will perform a NEW install of ZphpBB2 and leave the existing phpBB_* tables that are found in your Zikula database.</br></br>";
  $lang['ZphpBB2_Upgrade_Disclaimer'] .= "Once this is done there is NO WAY to turn back from this upgrade, so be very sure you have a recent backup of your Zikula and phpBB2 databases.";
  $lang['ZphpBB2_bad_version']  = "Version mismatch.<br /><br />Stand alone conversion is only supported with versions 2.0.1 or above.<br /><br />";
  $lang['ZphpBB2_bad_version'] .= "You would also receive this error if you are attempting to convert a phpBB 2.1.x(2.2) forum.<br /><br />";
  $lang['ZphpBB2_bad_version'] .= "Version information found: ";
  ...
  $lang['ZphpBB2_Removed'] = "ZphpBB2 has been removed.";
  $lang['ZphpBB2_Remove_Text'] = "Your about to remove ZphpBB2 and all its associated tables from Zikula (%s*).<br /><br />All data will be lost, are you sure you wish to do this?";
  $lang['ZphpBB2_Remove_Title'] = "Removing ZphpBB2 tables from %s*";
  $lang['ZphpBB2_Remove_Notes'] = "The ZphpBB2 tables have been removed.";
  ...
  $lang['ZphpBB2_Progress'] = "Progress";
  $lang['ZphpBB2_Some_Failed'] = "Some queries failed, the statements and errors are listing below:<br />(Some action may be needed to add, edit, or remove tables or records)<br />";
  $lang['ZphpBB2_No_Errors'] = "No errors";
  $lang['ZphpBB2_Results'] = "Results";
...
$lang['pnphpbb2_allow_full_page_explain'] = "While in the forum, allow users to minimize and maximize forum to full page width outside of the Zikula theme.";

$lang['pnphpbb2_full_page'] = "Default forum to full page (maximize) view";
$lang['pnphpbb2_full_page_explain'] = "Allows administrator to display forum in either full page view or within the Zikula theme.";

$lang['pnphpbb2_pn_pm'] = "Use Zikula's Private messaging system";
$lang['pnphpbb2_pn_pm_explain'] = "This will switch ALL the links to the private messaging system over to the ones used in Zikula rather than use the forums PM system.";

$lang['pnphpbb2_pn_link'] = "Link to return users back to your Zikula site";
$lang['pnphpbb2_pn_link_explain'] = "This will be a valid html link that will return your used back to your main site, if they are using a out of Zikula style/theme.";
...
$lang['Rank_image_explain'] .= '<br/>This is relative to ZphpBB2 root path if you include a path relative to the where the images are located.<br/>(NOTE: If only the image is specified (image.gif), then an attempt will be made to use the image based on the template name, Zikula theme, and language.)'; 
