 ...
 *
 *   $Id: usercp_avatar.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
//			$move_file($avatar_filename, './' . $board_config['avatar_path'] . "/$new_filename");
			/* Check permissions in order to give a meaningful error message */
			if (!is_writable($board_config['avatar_path'])) {
				$error = true;
				$error_msg = "Unable to copy avatar file: permission denied.";
				return;
			}
			if (!@$move_file($avatar_filename, $board_config['avatar_path'] . "/$new_filename")) {
				$error = true;
				$error_msg = "Unable to copy avatar file.";
				return;
			}
// End PNphpBB2 Module
		}
...
//	global $board_config, $db, $template, $lang, $images, $theme;
	global $board_config, $db, $template, $lang, $images, $phpbb_theme;
// End PNphpBB2 Module
...
*/
			...
			{
			 	 $avatar_path = $board_config['avatar_gallery_path'] . '/' . $category . '/';
			}
			$template->assign_block_vars('avatar_row.avatar_column', array(
				"AVATAR_IMAGE" =>  $avatar_path . $avatar_images[$category][$i][$j], 
				"AVATAR_NAME" => $avatar_name[$category][$i][$j])
			);
// End PNphpBB2 Module
