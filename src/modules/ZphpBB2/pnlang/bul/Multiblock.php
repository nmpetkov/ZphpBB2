...
define("_MULTIBLOCK_OPTIONS", "ZphpBB2 MultiBlock Options");
...
define("_POST_BY","от"); # by
define("_POST_ON","на"); # on
define("_POST_AT","в"); # at
define("_GOTO_BOARD","[Към форума]"); # Access Forum
