 ...
 *
 *   $Id: admin_user_ban.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
//	$module['Users']['Ban_Management'] = $filename;
	$phpbb_module['Users']['Ban_Management'] = $filename;
// End PNphpBB2 Module
...
//	$message = $lang['Ban_update_sucessful'] . '<br /><br />' . sprintf($lang['Click_return_banadmin'], '<a href="' . append_sid("admin_user_ban.$phpEx") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("index.$phpEx?pane=right") . '">', '</a>');
	$message = $lang['Ban_update_sucessful'] . '<br /><br />' . sprintf($lang['Click_return_banadmin'], '<a href="' . append_sid("admin_user_ban.$phpEx") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="' . append_sid("admin.$phpEx?pane=right") . '">', '</a>');
// End PNphpBB2 Module
...
//		$select_userlist .= '<option value="' . $user_list[$i]['ban_id'] . '">' . $user_list[$i]['username'] . '</option>';
		$select_userlist .= '<option value="' . $user_list[$i]['ban_id'] . '">' . pnVarPrepForDisplay($user_list[$i]['username']) . '</option>';
// End PNphpBB2 Module
		$userban_count++;
	}
