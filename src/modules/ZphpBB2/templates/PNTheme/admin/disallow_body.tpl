...
<tr>
<td class="row2" align="center"><span class="maintitle">{L_DISALLOW_TITLE}</span></td>
</tr><tr>
<td class="row2"><div class="genmed">{L_DISALLOW_EXPLAIN}</div></td>
</tr></table>
